...
public class N1qlJoinResolver {
	...
	public static class N1qlJoinResolverParameters {
		private final N1qlJoin joinDefinition;
		private final String lksId;
		private final TypeInformation<?> entityTypeInfo;
		private final TypeInformation<?> associatedEntityTypeInfo;
